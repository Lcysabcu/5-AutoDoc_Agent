...
# Configuration paths
PLANNER_AGENTS_PATH = "config/planner_agents_program_zh.yaml"
PLANNER_TASKS_PATH = "config/planner_tasks_program_zh.yaml"
DOC_AGENTS_PATH = "config/documentation_agents_program_zh.yaml"
DOC_TASKS_PATH = "config/documentation_tasks_program_zh.yaml"
